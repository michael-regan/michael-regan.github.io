...
var events = [
    ['Susan cut the recipes from the magazine with a sharp knife', 'cut-21.1', 'NP V NP PP.source PP.instrument', 'Instrument Remove', 'incremental accomplishment', 'Sbj V Obj PathP with Obl', "cut('Susan', 'knife', 'recipes', 'magazine')", 'Theme-of(z,e) & Component-of(a,Susan) & Component-of(b,knife) & Component-of(c,recipes) & Component-of(d,magazine) & UndAct(a,i,j,q1) & UndAct(b,i,k,q2) & IncrAcc(c,i,l,q3) & InhStPh(d,i,m,q4) & VOL(q1) & CNTC(q2) & -MER(q3) & EXST(q4) & FRC(a,b) & FRC(b,c) & PTH(c,d)'],

    ['Doug cleaned the table of dishes', 'clear-10.3', 'NP V NP.location PP.theme', 'Volitional Uncover', 'incremental accomplishment', 'Sbj V Obj of Obl', "cleaned('Doug', 'dishes', 'table')", 'Theme-of(z,e) & Component-of(a,Doug) & Component-of(b,dishes) & Component-of(c,table) & UndAct(a,i,j,q1) & UndAct(b,i,k,q2) & IncrAcc(c,i,l,q3) & VOL(q1) & REM(q2) & -MER(q3) & FRC(a,b) & PTH(b,c)'],
    ...
    ['David constructed a house out of sticks', 'create-26.4', 'NP V NP PP.material', 'Volitional Form', 'nonincremental accomplishment', 'Sbj V Obj from/out of Obl', "constructed('David', 'sticks', 'house')", 'Theme-of(z,e) & Component-of(a,David) & Component-of(b,sticks) & Component-of(c,house) & UndAct(a,i,j,q1) & UndAct(b,i,k,q2) & NonIncrAcc(c,i,l,q3) & VOL(q1) & FORM(q2) & DES(q3) & FRC(a,b) & FORM(b,c)'],
    ...
    ['The cat clawed the couch to pieces with her sharp nails', 'swat-18.2', 'NP V NP PP.result PP.instrument', 'Instrument COS', 'nonincremental accomplishment', 'Sbj V Obj ResultP with Obl', "clawed('cat', 'nails', 'couch')", 'Theme-of(z,e) & Component-of(a,cat) & Component-of(b,nails) & Component-of(c,couch) & UndAct(a,i,j,q1) & UndAct(b,i,k,q2) & NonIncrAcc(c,i,l,q3) & VOL(q1) & CNTC(q2) & COS(q3) & FRC(a,b) & FRC(b,c)'],
